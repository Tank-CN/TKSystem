...
public class XmlTool {
	...
	public static String getElementValue(String eleName, Element parentElement) {
		if (CommonUtils.isNull(parentElement)) {
			return null;
		} else {
			Element element = parentElement.element(eleName);
			if (CommonUtils.isNotNull(element)) {
	...
	public static List<Element> getElementByPath(Document document, String path) {
		return document.selectNodes(path);
	}

	public static Element getSingleNodeByPath(Document document, String path) {
		return (Element) document.selectSingleNode(path);
	}

	public static Document findCDATA(Document body, String path) {
		return XmlTool.stringToXml(XmlTool.getElementValue(path, body.getRootElement()));
	}
	...
	public static Document read(File file, String charset) {
		...
		if (CommonUtils.isNotNull(charset)) {
