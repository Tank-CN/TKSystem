	...
	<div class="page-bar clearfix">
		...
		<div class="page-bar-actions">
			<a class="btn btn-success btn-sm"
				href="${ctx}/admin/bas/organization/addView?pcode=2&subcode=3"> <i
...
</script> <script type="text/javascript" src="${ctx}/res-build/config.js" data-init="organization.js"></script>
</content>