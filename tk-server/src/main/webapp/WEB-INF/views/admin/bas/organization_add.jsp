            ...
            <form action="#" id="form_edit" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="title" name="title" placeholder="医院名称" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="address" name="address" placeholder="医院地址" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="traffic" name="traffic" placeholder="交通情况" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="serverman" name="serverman" placeholder="服务人员" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="servercontent" name="servercontent" placeholder="服务内容"
                                   class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="serverpay" name="serverpay" placeholder="服务费用" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="serverphone" name="serverphone" placeholder="服务热线"
                                   class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="disease" name="disease" placeholder="擅长病种" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <%--<div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="spell" name="spell" placeholder="拼音码" class="form-control">
                        </div>
                    </div>--%>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="code" name="code" placeholder="机构代码" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="fax" name="fax" placeholder="医院传真" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="website" name="website" placeholder="医院网址" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-3 col-md-9">
                                ...
                                <a href="${ctx}/admin/bas/organization?pcode=2&subcode=3"
...
<content tag="jsconfig">
    ...
    <script type="text/javascript" src="${ctx}/res-build/config.js" data-init="organization-add.js"></script>
