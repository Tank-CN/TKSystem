	...
	<div class="page-bar clearfix">
		...
		<div class="page-bar-actions">
			<a class="btn btn-success btn-sm"
				href="${ctx}/admin/bussiness/sign/addView?pcode=3&subcode=2"> <i
				class="iconfont">&#xe612;</i> <span class="hidden-480">添加签约</span>
			</a>
		</div>
	</div>
	<!-- END PAGE HEADER-->
							...
							<table class="table table-striped table-bordered table-hover dataTable no-footer"
								...
								<thead>
									<tr role="row">
										...
										<th class="sorting">申请签约时间</th>
										<th class="sorting">签约时间</th>
...
</script> <script type="text/javascript" src="${ctx}/res-build/config.js" data-init="sign.js"></script>
</content>