            ...
            <form action="#" id="form_edit" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="form-body">
                     <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="name" name="name" placeholder="用户姓名" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                          <input type="text"  data-required="1" name="orgname"  placeholder="机构名称" class="form-control"  style="position:relative;" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                        <input type="text"  data-required="1" name="deptname"  placeholder="科室名称" class="form-control"  value="">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="applysigndate" name="applysigndate" placeholder="申请签约时间" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="signdate" name="signdate" placeholder="签约时间" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="expiredate" name="expiredate" placeholder="到期时间" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="doctorid" name="doctorid" placeholder="签约医生ID" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="doctorname" name="doctorname" placeholder="签约医生名称" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="orgid" name="orgid" placeholder="签约机构ID" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="orgname" name="orgname" placeholder="签约机构名称" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="applycanceldate" name="applycanceldate" placeholder="申请解约时间" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="canceldate" name="canceldate" placeholder="解约时间" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="verifyapplydate" name="verifyapplydate" placeholder="申请审核时间" class="form-control">
                        </div>
                    </div>
                     <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="verifyapplyuser" name="verifyapplyuser" placeholder="申请审核人" class="form-control">
                        </div>
                    </div>
                     <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="verifycancelddate" name="verifycancelddate" placeholder="解约审核时间" class="form-control">
                        </div>
                    </div>
                     <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="verifycancelduser" name="verifycancelduser" placeholder="解约审核人" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-3 col-md-9">
                                ...
                                <a href="${ctx}/admin/bussiness/sign?pcode=3&subcode=2"
...
<content tag="jsconfig">
    ...
    <script type="text/javascript" src="${ctx}/res-build/config.js" data-init="sign-add.js"></script>
