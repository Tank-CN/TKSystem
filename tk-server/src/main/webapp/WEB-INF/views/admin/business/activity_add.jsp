            ...
            <form action="#" id="form_edit" class="form-horizontal" method="post" enctype="multipart/form-data">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="bname" name="bname"  placeholder="商家名称" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
...
<content tag="jsconfig">
    <script type="text/javascript" src="${ctx}/res-build/config.js" data-init="activity_add.js"></script>
