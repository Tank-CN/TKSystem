...
<body>
<div class="page-bar clearfix" style="background: none">
    <ul class="page-tab">
            ...
            <form action="#" id="form_edit" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="title" name="title" placeholder="服务名称" class="form-control">
                        </div>
                    </div>
...
<script type="text/javascript">
    var doctorId =${docid};
     ...
     document.getElementById('form_edit').action="${ctx}/admin/bussiness/serviceitem/saveorupdate";
     document.getElementById('doctorinfo').innerHTML='<a href="${ctx}/admin/bas/doctor/updateView?id='+doctorId+'&pcode=2&subcode=5&tabindex=0&currentpage='+currentpage+'">医生信息</a>';
     document.getElementById('returndoctor').href="${ctx}/admin/bas/doctor/updateView?id="+doctorId+"&pcode=2&subcode=5&tabindex=1&currentpage="+currentpage;
    
    
    
    </script>
    <script type="text/javascript" src="${ctx}/res-build/config.js" data-init="listbydoc-add.js"></script>
