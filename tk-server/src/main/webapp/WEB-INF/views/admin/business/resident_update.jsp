            ...
            <form action="#" id="form_edit" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="form-actions-topbox">
                        <div class="form-actions-fixtop">
                            <div class="row">
                                <div class="col-md-offset-3 col-md-9">
                                    ...
                                    <a href="${ctx}/admin/bussiness/resident?pcode=3&subcode=1&currentpage=${currentpage}"
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="realname" name="realname" placeholder="真实姓名" class="form-control" disabled>
                        </div>
                    </div>
                     <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="nickname" name="nickname" placeholder="用户昵称" class="form-control" disabled>
                        </div>
                    </div>
                   <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <select name="cardtype" class="form-control" disabled>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="idcard" name="idcard" placeholder="证件号码" class="form-control" disabled>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="nation" name="nation" placeholder="民族" class="form-control" disabled>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="birthplace" name="birthplace" placeholder="出生地" class="form-control" disabled>
                        </div>
                    </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="occupation" name="occupation" placeholder="职业" class="form-control" disabled>
                        </div>
                    </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="company" name="company" placeholder="工作单位" class="form-control" disabled>
                        </div>
                    </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="health_sn" name="health_sn" placeholder="健康卡号" class="form-control" disabled>
                        </div>
                    </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="ehr_sn" name="ehr_sn" placeholder="医保卡号" class="form-control" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" data-required="1" name="regionname" placeholder="所属地区"
                                   class="form-control" style="position:relative;" disabled>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="mobile" name="mobile" placeholder="电话" class="form-control" disabled>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="detailadr" name="detailadr" placeholder="详细地址" class="form-control" disabled>
                        </div>
                    </div>
                     <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="address" name="address" placeholder="地址" class="form-control" disabled>
                        </div>
                    </div>
                     <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="email" name="email" placeholder="邮箱" class="form-control" disabled>
                        </div>
                    </div>
                     <div class="form-group">
                        <label class="control-label col-md-3">地址</label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <select name="sexcode" class="form-control" disabled>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="birthdate" name="birthdate" placeholder="出生日期" class="form-control" disabled>
                        </div>
                    </div>
                    ...
                    <!--  <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="header" name="header" placeholder="头像" class="form-control" disabled>
                        </div>
                    </div> -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div id="selImg" class="form-control"><i class="iconfont">&#xe626;</i>
                                <span>选择图片</span></div>
                            <input type="file" id="file" name="file" class="" style="display: none" disabled>
...
<script type="text/javascript">
        var residentId =${id},currentpage=${currentpage};
    </script>
    <script type="text/javascript" src="${ctx}/res-build/config.js" data-init="resident-update.js"></script>
