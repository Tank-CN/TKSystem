	...
	<div class="page-bar clearfix">
		...
		<div class="page-bar-actions">
			<a class="btn btn-success btn-sm"
				href="${ctx}/admin/bussiness/serviceitem/addView?pcode=2&subcode=6"> <i
				class="iconfont">&#xe612;</i> <span class="hidden-480">添加项目</span>
			</a>
		</div>
	</div>
	<!-- END PAGE HEADER-->
...
</script> <script type="text/javascript" src="${ctx}/res-build/config.js" data-init="service.js"></script>
</content>