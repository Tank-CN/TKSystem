                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9" style="width: 50%">
                            <textarea class="form-control" rows="3" disabled id="info" placeholder="商户简介"
                                      name="info"></textarea>
                        </div>
                    </div>
...
<content tag="jsconfig">
    ...
    <script type="text/javascript" src="${ctx}/res-build/config.js" data-init="business_apply_update.js"></script>
