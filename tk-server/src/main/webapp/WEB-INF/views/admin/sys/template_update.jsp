            ...
            <form class="form-horizontal" id="form_edit">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" name="name" disabled class="form-control" placeholder="请输入模板名称，例如：门诊预约">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <label class="radio-inline">
                                <input type="radio" name="type" disabled id="type1" checked value="1"> 消息
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="type" disabled id="type2" value="2"> 短信
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <textarea id="text" name="text" disabled class="form-control" rows="5"></textarea>

                            <div class="variable-wrap clearfix">
                                <div class="tit">变量：</div>
                                <div class="variable-con">
                                    <button type="button" disabled class="btn btn-info btn-xs j-variable-btn">#姓名#
                                    </button>
                                    <button type="button" disabled class="btn btn-info btn-xs j-variable-btn">#日期#
                                    </button>
                                    <button type="button" disabled class="btn btn-info btn-xs j-variable-btn">#时间#
                                    </button>
                                    <button type="button" disabled class="btn btn-info btn-xs j-variable-btn">#星期几#
                                    </button>
                                    <button type="button" disabled class="btn btn-info btn-xs j-variable-btn">#医院名称#</button>
                                    <button type="button" disabled class="btn btn-info btn-xs j-variable-btn">#科室名称#</button>
                                    <button type="button" disabled class="btn btn-info btn-xs j-variable-btn">#医生姓名#</button>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" name="code" disabled class="form-control" placeholder="请输入模板自定义代码">
                        </div>
                    </div>
            ...
            <div class="modal-body">
                <div class="dialogtip-con-wrap clearfix dialogtipg-success">
                    ...
                    <div class="dialogtip-con">
                        ...
                        <div class="dialogtip-msg">模板保存成功</div>
                    </div>
                </div>
            </div>
...
<content tag="jsconfig">
    ...
    <script type="text/javascript" src="${ctx}/res-build/config.js" data-init="template-update.js"></script>
</content>
