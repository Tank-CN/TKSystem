...
<body>
	...
	<div class="row">
		<div class="col-md-4">
			...
			<div class="portlet portlet-blue portlet-module">
				...
				<div style="margin-bottom: 5px;width:336px; padding: 5px 10px">
					<input type="text" id="dictionaryName" name="dictionaryName"  placeholder="字典名称" style="width: 69%; padding-left: 5px;"/>
	...
	<!-- END PAGE CONTENT-->
	<content tag="jsconfig"> <script type="text/javascript" src="${ctx}/res-build/config.js" data-init="dictionary.js"></script> </content>
</body>
