        ...
        bind: function () {
            ...
            $form.validate({
                ...
                submitHandler: function () {
                    var createObjPath = ROOTPAth + '/admin/sys/role/update';
        ...
        getModule: function () {
            ...
            var listTpl = juicer(
                [
                    ...
                    '    <td>',
                    //添加权限
                    '    <button type="button" disabled="disabled"  class="btn btn-default btn-xs j-add" data-toggle="confirmation" data-placement="top"',
                    '{@if item.flag === 0}',
                    '',
                    '{@else}',
                    'style="display:none"',
                    ...
                    //删除权限
                    '    <button type="button" disabled="disabled"  class="btn btn-danger btn-xs j-del" data-toggle="confirmation" data-placement="top"',
                    '{@if item.flag === 0}',
                    'style="display:none"',
                    '{@else}',
                    '',
                    ...
                    '><span  class="iconfont iconfont-xs">&#xe61f;</span>添加权限 </button>',
                    //删除权限
                    '    <button type="button" class="btn btn-danger btn-xs j-del" disabled="disabled" data-toggle="confirmation" data-placement="top"',
                    '{@if subitem.flag === 0}',
                    'style="display:none"',
                    '{@else}',
                    '',
            ...
            $.post(modulesPath, {"roleId": roleId}, function (data) {
