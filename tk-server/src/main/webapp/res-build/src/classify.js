    ...
    var Utilitiy = {
            ...
            $tree.jstree({
                ...
                "core": {
                    ...
                    'data': {
                        async: true,
                        'url': function (node) {
                            return ROOTPAth + '/admin/sys/classify/rootNode';
                        },
                        'data': function (node) {
        ...
        bind: function () {
            ...
            $tree.bind('activate_node.jstree', function (e, data) {
                ...
                if (data.node.id === '#') {
                    var postPath = ROOTPAth + '/admin/sys/classify/get/0';
                } else {
                    var postPath = ROOTPAth + '/admin/sys/classify/get/' + data.node.id;
                }
            ...
            $modifyNodeForm.validate({
                ...
                submitHandler: function () {
                    var savePath = ROOTPAth + '/admin/sys/classify/update';
            ...
            $addModuleForm.validate({
                ...
                submitHandler: function () {
                    var savePath = ROOTPAth + '/admin/sys/classify/create';
        ...
        deleteModule: function (moduleId) {
            var delPath = ROOTPAth + '/admin/sys/classify/delete/' + moduleId;
            $.ajax({
                url: delPath,
                type: "post",
