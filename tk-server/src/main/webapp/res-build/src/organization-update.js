...
define(function(require, exports, module) {
    ...
    var Utilitiy = {
        ...
        initForm: function() {
            ...
            $.ajax({
                type: "POST",
                url: ROOTPAth + "/admin/bas/organization/detail/" + organizationID,
                dataType: "json",
                            ...
                            if (data) {
                                ...
                                if (newdata.code === 1) {
                                    ...
                                    $tipModal.on('show.bs.modal', function(event) {
                                        $tipModal.find(".j-modal-closebtn").attr("href", ROOTPAth + "/admin/bas/organization/updateView?id=" + organizationID + "&pcode=2&subcode=3&currentpage=" + currentpage)
                                    });
                                    $tipModal.modal("show");
                                }
