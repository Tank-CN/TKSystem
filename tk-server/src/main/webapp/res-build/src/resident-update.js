...
define(function(require, exports, module) {
    ...
    var Utilitiy = {
        ...
        initForm: function() {
            ...
            $.ajax({
                type: "POST",
                url: ROOTPAth + "/admin/bussiness/resident/detail/",
                dataType: "json",
                data: {
                    id: residentId
                },
        ...
        bind: function() {
            ...
            $addForm.validate({
                rules: {
                    ...
                    //     required: true,
                    //     remote: { //自带远程验证存在的方法
                    //         url: ROOTPAth + '/admin/bussiness/resident/code/check',
                    //         type: "GET",
                    //         dataType: "json",
                    //         data: {
                    //             /*username: function () {
                        ...
                        success: function(data) {
                            ...
                            if (newdata.code === 1) {
                                ...
                                $tipModal.on('show.bs.modal', function(event) {
                                    $tipModal.find(".j-modal-closebtn").attr("href", ROOTPAth + "/admin/bussiness/resident/updateView?id=" + residentId + "&pcode=3&subcode=1&currentpage=" + currentpage)
                                });
                                $tipModal.modal("show");
                            }
                        },
