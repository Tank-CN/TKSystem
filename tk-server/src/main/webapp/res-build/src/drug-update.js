...
define(function (require, exports, module) {
    ...
    var Utilitiy = {
        init: function () {
            ...
            $.ajax({
                type: "POST",
                url: ROOTPAth + "/admin/drug/detail",
                data: {id: drugid},
                dataType: "json",
            ...
            $addForm.validate({
                ...
                submitHandler: function (fm) {
                    $.ajax({
                        type: "POST",
                        dataType: "json",
                        url: ROOTPAth + "/admin/drug/update",
                        ...
                        success: function (data) {
                            ...
                            if (data.code===1) {
                                ...
                                $tipModal.on('show.bs.modal', function (event) {
                                    $tipModal.find(".j-modal-closebtn").attr("href",ROOTPAth +"/admin/drug/updateView?id="+drugid+"&pcode=RMdc&subcode=MdcDrug")
                                });
                                $tipModal.modal("show");
                            }
                        }
