...
define(function(require, exports, module) {
    ...
    var listTpl = juicer(
        [
            ...
            '        <a href="' + ROOTPAth + '/admin/bas/organization/updateView?id=${item.id}&currentpage=${item.currentpage}&pcode=2&subcode=3" class="btn btn-default btn-xs j-edit" ><span class="iconfont iconfont-xs">&#xe62d;</span>查看</a> ',
            //删除
    ...
    var Utilitiy = {
        init: function() {
            ...
            pageIndex = new Page({
                ajax: {
                    url: ROOTPAth + '/admin/bas/organization/list',
                    type: 'POST',
                    dataType: 'json',
                    data: function() {
        ...
        delitem: function($that) {
            ...
            var delPath = ROOTPAth + '/admin/bas/organization/delete/' + organizationid;
            $.ajax({
                url: delPath,
                type: "POST",
