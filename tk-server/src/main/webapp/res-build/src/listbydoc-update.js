                        ...
                        success: function(data) {
                            ...
                            if (newdata.code === 1) {
                                ...
                                $tipModal.on('show.bs.modal', function(event) {
                                    $tipModal.find(".btn-success").attr("href", tabnum + "admin/bas/doctor/updateView?id=" + doctorId + "&pcode=2&subcode=5&tabindex=1&scurrentpage" + scurrentpage + "&currentpage=" + currentpage)

                                    $tipModal.find(".j-modal-closebtn").attr("href", tabnum + "admin/bussiness/serviceitem/updateViewByDoc?id=" + serviceId + "&pcode=2&subcode=5&docid=" + doctorId + "&scurrentpage=" + scurrentpage + "&currentpage=" + currentpage)
                                });
                                $tipModal.modal("show");
                            }
                        },
